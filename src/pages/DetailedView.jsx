...
const DetailedView = () => {
  ...
  return (
    <>
      ...
      <ScrollAnimation>
        <div>
          {/* <div className="flex md:flex-col flex-row gap-6 p-6">
              ...
              <section className="p-6 space-y-4 shadow-lg bg-white rounded-2xl">
                <div className="text-center">
                  ...
                  <div className="text-3xl font-bold mt-2">
                    ${house.price.toLocaleString()} {house.priceUnit}/{house.priceFrequency}
                  </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 p-6 property-container">
            ...
            <div className="w-full md:w-2/3 space-y-6">
              ...
              <div>
                <h2 style={{color:"black"}} className="text-xl font-semibold mt-4 mb-2">Overview</h2>
                <p style={{color:"gray"}}className="">{house.overview}</p>
              </div>
              <div>
                <h2 style={{color:"black"}} className="text-xl font-semibold mt-4 mb-2">Desctiption</h2>
                <p style={{color:"gray"}}className="">{house.description}</p>
              </div>

              <div>
                <h2 style={{color:"black"}} className="text-xl font-semibold mt-4 mb-2">Features</h2>
                <ul className="text-gray-700 list-disc list-inside space-y-1">
                  {house.features.map((feature, index) => {
                    const Icon = iconMap[feature] || Tag;
                    return (
              ...
              <div>
                <h2 style={{color:"black"}} className="text-xl font-semibold mt-4 mb-2">Amenities</h2>
                <div className="flex flex-wrap gap-2 text-sm text-gray-700">
                  {house.amenities.map((amenity, index) => {
                    const Icon = iconMap[amenity] || Tag;
                    return (
              ...
              <div>
                <h2 style={{color:"black"}} className="text-xl font-semibold mt-4 mb-2">Labels</h2>
                <div className="flex flex-wrap gap-2 text-sm text-gray-700">
                  {house.labels.map((label, index) => {
                    const Icon = iconMap[label] || Tag;
                    return (
            ...
            <div className="md:w-1/3 ">
              <section className="p-6 space-y-4 shadow-lg bg-white rounded-2xl right-section">
                <div className="text-center">
                  <h2 style={{color:"black"}} className="text-lg font-semibold text-gray-700">
                    Property for {house.status}
                  </h2>
                  <div className="text-3xl font-bold mt-2">
