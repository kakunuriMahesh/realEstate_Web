  ...
  return (
    <AnimatedSection animationClass="zoom-in house-card ">
      <div
        ...
        className="bg-green-800 house-card border-2 border-b-0 border-t-amber-50 border-r-amber-50 border-l-amber-50 rounded-lg shadow-md overflow-hidden h-[335px] sm:w-[270px] lg:w-[270px] cursor-pointer hover:shadow-lg transition-shadow duration-300"
      >
        <div className="relative overflow-hidden">
          ...
          />
          <h1 className="absolute top-2 left-2 bg-white rounded-md px-1">
            {house.status}
          </h1>
        </div>
